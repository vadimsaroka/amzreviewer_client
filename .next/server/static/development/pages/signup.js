...
class SignUpPage extends react__WEBPACK_IMPORTED_MODULE_1___default.a.Component {
  constructor() {
    super();
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(this, "onSubmit", async e => {
      ...
      try {
        ...
        if (res.data.status === "success") {
          window.setTimeout(() => {
            next_router__WEBPACK_IMPORTED_MODULE_3___default.a.push(`/me`);
          }, 500);
        }
      } catch (err) {
        alert(err.response.data.message);
...
module.exports = __webpack_require__(/*! /home/vadim/Documents/amz/client/pages/signup.js */"./pages/signup.js");
